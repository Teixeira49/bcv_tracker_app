...
A la última actualización de esta regla los 10 archivos están en paridad con **88 claves**, y `AppMessages` expone exactamente esas. Si el script reporta una diferencia, el cambio está incompleto.
