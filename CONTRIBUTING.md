...
El lint `public_member_api_docs` **no está activo**, y es deliberado: activarlo obligaría a escribir exactamente los comentarios que la sección anterior prohíbe. De los 339 avisos que reporta hoy, **194 caen en esos tres registros mecánicos** (`app_messages.dart` 100, `colors_values.dart` 77, `icons_constants.dart` 17).
