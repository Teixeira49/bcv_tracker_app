...
El lint `public_member_api_docs` **no está activo**, y es deliberado: activarlo obligaría a escribir exactamente los comentarios que la sección anterior prohíbe. De los 319 avisos que reporta hoy, **179 caen en esos tres registros mecánicos** (`app_messages.dart` 85, `colors_values.dart` 77, `icons_constants.dart` 17).
